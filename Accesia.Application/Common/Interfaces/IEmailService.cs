...
public interface IEmailService
{
    ...
    Task SendAccountDeletionConfirmationEmailAsync(string email, string fullName, string deletionToken, DateTime tokenExpiration, CancellationToken cancellationToken = default);
    Task SendAccountMarkedForDeletionEmailAsync(string email, string fullName, DateTime permanentDeletionDate, CancellationToken cancellationToken = default);
    Task SendAccountDeletionCancelledEmailAsync(string email, string fullName, CancellationToken cancellationToken = default);
} 