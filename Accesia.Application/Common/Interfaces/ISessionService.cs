...
{
    Task<Session> CreateSessionAsync(User user, DeviceInfo deviceInfo, LocationInfo locationInfo, string loginMethod,
    ...
    Task RevokeAllUserSessionsExceptCurrentAsync(Guid userId, string currentSessionToken,
        CancellationToken cancellationToken = default);
