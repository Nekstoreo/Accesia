...
public class LogoutAllDevicesHandler : IRequestHandler<LogoutAllDevicesCommand, LogoutAllDevicesResponse>
{
    ...
    public async Task<LogoutAllDevicesResponse> Handle(LogoutAllDevicesCommand request,
        CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogWarning(
                "Intento de logout de todos los dispositivos con token de sesión inválido desde IP: {IpAddress}",
                request.IpAddress);
        ...
        {
            _logger.LogWarning(
                "Intento de logout de todos los dispositivos con sesión no activa {SessionToken} para usuario {UserId}",
        ...
        _logger.LogInformation(
            "Iniciando logout de todos los dispositivos para usuario {Email}. Sesiones activas: {ActiveSessions}",
        ...
        _logger.LogInformation(
            "Logout de todos los dispositivos completado para usuario {Email}. {SessionsTerminated} sesiones terminadas",
            currentSession.User.Email.Value, activeSessions);
